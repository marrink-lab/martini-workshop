...
`genome.ig` is given and contains a random 20 kilobase sequence.
...
>[!NOTE]
> Before using the generated chromosome `.itp` file in an MD simulation, the topology requires two
> additional modifications. First, an elastic network has to be generated based on initial
coordinates of the chromosome. Secondly, for a succesfull energy minimization, all the constraints
in the chromosome topolgy have to be converted to stiff bonds.
...
<div align="center">
<img src="../figures/04_chromosome.png" width="70%"/>
</div>

*__Figure 2: Chromosome__ A render of the initial structure of the chromosome generated by
**Polyply**.*
...
```
<div align="center">
<img src="../figures/04_envelope.png" width="70%"/>
</div>

*__Figure 3: Cell envelope__ A render of the initial structure of the cell envelope generated by **TS2CG**.*
    ...
    <table>
	    <tr>
    	    <td style="padding:10px" width="50%">
                <img src="../figures/04_chromosome_and_envelope.png"/>
      	    </td>
    	    <td style="padding:10px" width="50%" float="center">
                <img src="../figures/04_mask.png" width="100%"/>
            </td>
        </tr>
    </table>
</div>

*__Figure 3: Steps of creating a packing mask__ Left panel: The structure, i.e. the chromosome and
...
<div id="image-table">
    <table>
	    <tr>
    	    <td style="padding:10px" width="50%">
                <img src="../figures/04_cytosolic_proteins.png"/>
      	    </td>
    	    <td style="padding:10px" width="50%" float="center">
...
*__Figure 4: Steps of packig the cell__ Left panel: A render of only the cytosolic proteins that
